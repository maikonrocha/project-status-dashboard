...
export class ProjectsService {
    ...
    async getStatus(projectId: string, companyId?: string): Promise<StatusDashboardDto> {
        ...
        const throughputDistribution = this.metricsService.getThroughputDistribution(metrics);
        ...
        let simulationResults: Awaited<ReturnType<MonteCarloService['runSimulation']>> | null = null;
        ...
        const avgWeeklyThroughput = this.metricsService.getAverageWeeklyThroughput(metrics);
        ...
        return {
            ...
            tables: { remainingTasks: remainingTasksList, recentCompleted, weeklyThroughput },
        };
    }
}
