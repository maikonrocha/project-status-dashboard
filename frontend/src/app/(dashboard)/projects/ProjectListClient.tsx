    ...
    return (
      <div className="flex flex-col items-center gap-4 py-24 text-center">
        <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center">
          <svg
            className="w-8 h-8 text-blue-300/30"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <p className="text-blue-300/40">Nenhum projeto ainda.</p>
        <Link
          href="/projects/new"
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-white/10 bg-white/5">
            ...
            <th className="text-right px-5 py-3 text-blue-300/60 font-medium">
              Ações
            </th>
          </tr>
        </thead>
            ...
            >
              <td className="px-5 py-4">
                <div className="flex items-center gap-3">
                  <div
                    className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500/20 to-indigo-500/20
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-300/40 font-mono mt-0.5">
                      {project.epicId}
                    </p>
                  </div>
                </div>
