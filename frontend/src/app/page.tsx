    ...
    <main className="max-w-7xl mx-auto px-6 py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-blue-300/50 max-w-md mx-auto">
          Choose a project to view its live status dashboard, burndown chart, and Monte Carlo predictions.
        </p>
      </div>
      ...
      {projects.length === 0 ? (
        <div className="flex flex-col items-center gap-5 mt-16 text-center">
          <div className="w-20 h-20 rounded-full bg-white/5 flex items-center justify-center">
            <svg className="w-10 h-10 text-blue-300/30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
                d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
            </svg>
          </div>
          <p className="text-blue-300/40 text-lg">No projects yet</p>
          <Link
            href="/projects/new"
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-blue-300/40 font-mono mt-0.5">{project.epicId}</p>
                </div>
              </div>
